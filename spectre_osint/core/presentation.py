...
def _mention_card(finding: Finding) -> dict[str, Any]:
    ...
    return {
        ...
        "requested_username": str(data.get("requested_username") or data.get("query") or ""),
        "observed_username": str(data.get("observed_username") or data.get("matched_value") or ""),
        "originating_lead": str(data.get("originating_lead") or data.get("query") or ""),
